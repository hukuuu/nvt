function QueryResultSecond(container, queryResultContainerTemplate, postAjaxUrl, parsleyBlock, pageLastIdAwareLocal, isArrangingColumns) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == "SUCCESS") {
                    ...
                    data.dto.start=calculateStartRecordNumber(20);
                    data.dto.end=calculateEndRecordNumber(20,data.dto.totalCount );
                    container.empty();
    ...
    this.initFilter = function() {
        $("a.search-button,#searchButton2").not(".no-query").click(function(event) {
